...
export async function GET(request: Request) {
  ...
  let query = admin
    ...
    .select("*, centers!inner(name, country, city, email, inquiry_email, website_url, description, short_description, phone, address, treatment_focus, conditions, services, treatment_methods, setting_type, program_length, languages, pricing_text, accreditation, status, updated_at, is_unclaimed)", { count: "exact" })

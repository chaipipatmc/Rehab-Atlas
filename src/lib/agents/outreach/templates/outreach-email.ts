...
{
  "subject": "email subject line - use one of these two styles, alternating randomly: (A) 'Partnership with Rehab-Atlas - featuring [Center Name]' or (E) 'Rehab-Atlas x [Center Name] - partnership invitation'. IMPORTANT: use only plain ASCII characters in the subject. Use a hyphen (-) not em dash, and lowercase x not multiplication sign. Keep it professional and concise.",
